...
//$all_price_query = 'SELECT Cost, Item FROM items ORDER BY Cost ASC';
//$all_price_result = mysqli_query($con, $all_price_query);
...
<main>
    <div class="container">
        ...
        echo "<p class='para-text center'> <b>Item Name:</b> " . $this_item_record['Item'] . "<br>";
        echo "<p class='para-text center'> <b>Category:</b> " . $this_item_record['Category'] . "<br>";
        echo "<p class='para-text center'> <b>Calories:</b> " . $this_item_record['Calories'] . "kcal", "<br>";
        echo "<p class='para-text center'> <b>Cost: </b>$" . $this_item_record['Cost'] . "<br>";
        ...
        <br><br>
        <h3>SORT ITEMS</h3>
        <p class="para-text center">Please click on the headings to see each header sorted from the selected field</p>
        <?php
        ...
        <div id="content">
            <table width="100%" id="emp_table" class="table-striped">
                <tr class="tr_header">
                    <th><a href="?orderby=Item&order=<?php echo $ItemOrder; ?>">Item<?php echo $sort_arrow_item ?></a>
                    </th>
                    <th>
                    ...
                    <th><a href="?orderby=Cost&order=<?php echo $CostOrder; ?>">Cost<?php echo $sort_arrow_cost ?></a>
                    </th>
                </tr>
