    ...
    <div class="row">
            ...
            <div class="order-form">
                ...
                <form name="order_form" id='order_form' method="post" action="submit_order.php">
                    <div class="form-inline">
                        ...
                        <div class="center">
                            <label for="Email" class="label-text">Email:&emsp; &emsp;</label>
                            <input type="text" name="Email" id="Email" class="form-control">
                        </div>
                        <div class="center">
                            <label for="Item" class="label-text">Item Name:</label>
        ...
        <div class="col-sm-6">
            ...
            <div id="items-content">
                <table id="itemstable" width="100%" class="table-striped table-center">
                    <?php
                    //Availability query to populate table that shows available items only
                    $result = mysqli_query($con, "SELECT * FROM items WHERE Availability='1' ORDER BY Cost ASC; ");
