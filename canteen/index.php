    ...
    <div class="container">
                            ...
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <img class="d-block w-100" src="images/home_page/wgc_kids.png"
                                         alt="kids at wellington girls college">
                                </div>
                                <div class="carousel-item">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="para-text" style="padding-left: 2rem">
                            ...
                            and try some of our savoury and sweet treats, all at an affordable price. Enjoy!
                            <br>
                        </p>
                    </div>
                </div>
        ...
        <div class="card-deck">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text center">We offer a
                        wide range of wraps, pizzas, sandwiches and many more! Be sure to check it all out on our menu.</p>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text center">Treat yourself to some of our sweet treats at the canteen, ranging from
                        a variety of slices, jelly's and ice-creams.</p>
                    <a href="items.php" class="button-card btn btn-light center">Find out more</a>
                </div>
            </div>
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text center">Feeling like a refreshment? We've got you sorted...
                        whether that be a or a lemon tea, hot-chocolate or an iced coffee!</p>
                    <a href="items.php" class="button-card btn btn-light center">Find out more</a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="card">
                    <div class="card-body">
                        <img src="images/home_page/order_pic.png" class="center" alt="orders at cafe" width="450" height="300">
