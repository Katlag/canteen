...
//checks to see if the user is logged in as admin
if ((!isset($_SESSION['logged_in'])) or $_SESSION['logged_in'] != 1) {
    header("Location: error_page.php");
}

//items query to populate update items table
$update_items = "SELECT * FROM items";
$update_items_record = mysqli_query($con, $update_items);


//order query to populate orders table (Takes the ID corresponding to the written value and prints that)
...
<main>
    <div class="container">
        ...
        <br>
        <table id="items-content-update" width="100%">
            <tr>
