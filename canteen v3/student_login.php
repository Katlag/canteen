...
<div class="background_img_all">
            ...
            <div class="collapse navbar-collapse" id="navbarToggler">
                <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                    ...
                    <li class="nav-item navactive">
                        <a class="nav-title" href="student_login.php">SIGN IN</a>
                    </li>
                    <li class="nav-item hover">
    ...
    <h2>THE CANTEEN</h2>
    <h6><br>────── Student Login ──────</h6>
</div>

<div class="container center">
    <div>
        <img src="images/student_login/studentlogin_subheader.png" class="center" alt="student icon" width="500"
             height="125"><br>
        <h6>*Please enter your student Username and Password*</h6>
    </div>

    <main>
        <form name="login_form" id='login_form' method='post' action='process_login_student.php'>
            ...
            <input type="submit" name="submit" id="submit" value="Log In" class="button-card btn btn-light center">
        </form>
        <p class="para-text-signup">
            Haven't Registered?<a href="sign_up.php"> Sign up</a>
        </p>
    </main>
</div>
