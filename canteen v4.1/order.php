...
<div class="container">
    ...
    <hr style="border: 2px solid #89ADAE; width:50%">
    <p class="para-text center">Please find your name to confirm you have signed up successfully <br> ↓↓↓</p>

    <div class="center">
        <form name="customer_form" id="customer_form" method="get">
            <select id="item" name="CustomerID">
                <!--options-->
                <?php
                while ($all_customers_record = mysqli_fetch_assoc($all_customers_result)) {
                    echo "<option value = '" . $all_customers_record['CustomerID'] . "'>";
                    echo $all_customers_record['FName'];
                    echo '&nbsp;';
                    echo $all_customers_record['LName'];
                    echo "</option>";
                }
                ?>
            </select>
            <!--                <input type="submit" name="item_button" value="Customer Names"-->
            <!--                       class="button-card btn btn-light">-->
        </form>
        <p class="para-text-signup">
            Can't see your name?<a href="sign_up.php"> Sign up now!</a>
        </p>
    </div>
    <hr style="border: 2px solid #89ADAE; width:50%">
    ...
    <div class="order-form">
        ...
        <h6>*Please enter your First and Last Name and an item you'd like to purchase from the menu* <br></h6>
        ...
        <form name="order_form" id='order_form' method="post" action="submit_order.php">
            ...
            <div class="input-group">
                ...
                <small class="center">Please make sure the item exists on the menu before ordering</small>
            </div>
            <div class="input-group">
    ...
    <div class="row center">
        <div class="column">
            <p class="para-text-signup">Click below to view all the <b>available</b> items on the menu</p>
            <hr style="border: 2px solid #89ADAE; width:40%">
            <!--                <input type='submit' name='menu' value="View Menu" class="button-card btn btn-light center">-->
