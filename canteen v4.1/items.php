...
#selects the itemID and item from the items table
...
#selects all fields from items table, looking specifically each ID
...
#selects the item and category from items table, looking specifically each ID
